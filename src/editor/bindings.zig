...
const normal_bindings = [_]NormalBinding{
    ...
    .{ .sequence = "g0", .action = .move_line_start, .help = "jump to the start of the screen line" },
    .{ .sequence = "g^", .action = .move_line_nonblank, .help = "jump to first non-blank on the screen line" },
    .{ .sequence = "g$", .action = .move_line_end, .help = "jump to the end of the screen line" },
    ...
    .{ .sequence = "y$", .action = .yank_to_eol, .help = "yank to end of line" },
    .{ .sequence = "Y", .action = .yank_line, .help = "yank a line" },
